...
df['Dominant Hand'].replace(['Right','Left'],[1, 2], inplace=True)

df['Gender'].replace(['Female','Male'],[1, 2], inplace=True)

df['Family_History'].replace(['Yes','No'],[1, 2], inplace=True)

df['Smoking_Status'].replace(['Former Smoker','Current Smoker','Never Smoked'],[1, 2,3], inplace=True)
